# -*- coding: utf-8 -*-
"""
Created on Thurs June 16 11:26:09 2023
...
# Median values for all numeric data
numeric_column = df_agg_diff.select_dtypes(include=np.number).columns
metric_date_12mo = df_agg_diff['Video publish time'].max() - pd.DateOffset(months =12)
median_agg = df_agg_diff[df_agg_diff['Video publish time'] >= metric_date_12mo][numeric_column].median()
#print(median_agg)
